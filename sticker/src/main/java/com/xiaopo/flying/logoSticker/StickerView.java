...
public class StickerView extends FrameLayout {
  ...
  public void configDefaultIcons() {
    ...
    BitmapStickerIcon flipIcon = new BitmapStickerIcon(
        ContextCompat.getDrawable(getContext(), R.drawable.bring_front),
        BitmapStickerIcon.LEFT_TOP);
    flipIcon.setIconEvent(new BringToFront());
    BitmapStickerIcon BtoF = new BitmapStickerIcon(
            ContextCompat.getDrawable(getContext(), R.drawable.ic_action_name),
            BitmapStickerIcon.LEFT_BOTTOM);
    BtoF.setIconEvent(new RotateSticker());
...
//      moveMatrix.postRotate(newRotation - oldRotation, midPoint.x, midPoint.y);
  ...
  public void rotateOnly(MotionEvent rotateEvent)
  {
    rotateOnlyIcon(handlingSticker,rotateEvent );
  }

  public void rotateOnlyIcon(Sticker sticker, MotionEvent motionEvent) {
    if (sticker != null) {
      float newDistance = calculateDistance(midPoint.x, midPoint.y, motionEvent.getX(), motionEvent.getY());
      float newRotation = calculateRotation(midPoint.x, midPoint.y, motionEvent.getX(), motionEvent.getY());
