...
public class Utility {
   ...
   public static boolean checkPermissionContects(final Context context, final String string)
   {
               ...
               if (ActivityCompat.shouldShowRequestPermissionRationale((Activity) context,string)) {
                   ...
                   alertBuilder.setPositiveButton(android.R.string.yes, new DialogInterface.OnClickListener() {
                       ...
                       public void onClick(DialogInterface dialog, int which) {
                           ActivityCompat.requestPermissions((Activity) context, new String[]{string},
